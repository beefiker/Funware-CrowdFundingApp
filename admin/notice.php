                            ...
                            <div class="col-md-12 grid-margin">
                              <div class="table-responsive">
                                <table id="dtBasicExample" class="table table-striped table-bordered table-sm"
                                  ...
                                  <tbody>
                                    <?php
                                  $q4= $db->query('SELECT * FROM funware_notice'
                                  );
                ...
                <div class="col-md-12">
                  <div class="row">
                    <div class="col-md-12 grid-margin">
                      ...
                      <tbody>
                        <?php
                                  $q4= $db->query('SELECT funware_notice_dat.f_div AS p_div
                                                          ,sys_notice_id
                                                          ,sys_user_id
                                                          ,f_notice_title
                                                          ,auto_date 
                                                      ...
                                                      LEFT JOIN funware_notice
                                                        ON funware_notice_dat.sys_notice_id = funware_notice.ai_notice'
                                  );
                                  while($row = $q4->fetch(PDO::FETCH_ASSOC)){
                                    echo '<tr>';                  
